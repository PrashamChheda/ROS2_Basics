...
#include "my_robot_interfaces/msg/detail/alive_turtles_list__rosidl_typesupport_fastrtps_c.h"
...
using _AliveTurtlesList__ros_msg_type = my_robot_interfaces__msg__AliveTurtlesList;

static bool _AliveTurtlesList__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AliveTurtlesList__ros_msg_type * ros_message = static_cast<const _AliveTurtlesList__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
...
static bool _AliveTurtlesList__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _AliveTurtlesList__ros_msg_type * ros_message = static_cast<_AliveTurtlesList__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  // Field name: theta
  {
    ...
    if (ros_message->theta.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->theta);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->theta, size)) {
...
size_t get_serialized_size_my_robot_interfaces__msg__AliveTurtlesList(
  const void * untyped_ros_message,
...
static uint32_t _AliveTurtlesList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__msg__AliveTurtlesList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interfaces
size_t max_serialized_size_my_robot_interfaces__msg__AliveTurtlesList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__msg__AliveTurtlesList;
    is_plain =
      (
...
static size_t _AliveTurtlesList__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_my_robot_interfaces__msg__AliveTurtlesList(
...
static message_type_support_callbacks_t __callbacks_AliveTurtlesList = {
  "my_robot_interfaces::msg",
  "AliveTurtlesList",
  _AliveTurtlesList__cdr_serialize,
  _AliveTurtlesList__cdr_deserialize,
  _AliveTurtlesList__get_serialized_size,
  _AliveTurtlesList__max_serialized_size
};

static rosidl_message_type_support_t _AliveTurtlesList__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AliveTurtlesList,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, AliveTurtlesList)() {
  return &_AliveTurtlesList__type_support;
}
