...
class Metaclass_AliveTurtlesList(type):
    """Metaclass of message 'AliveTurtlesList'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_robot_interfaces.msg.AliveTurtlesList')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__alive_turtles_list
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__alive_turtles_list
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__alive_turtles_list
            cls._TYPE_SUPPORT = module.type_support_msg__msg__alive_turtles_list
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__alive_turtles_list
...
class AliveTurtlesList(metaclass=Metaclass_AliveTurtlesList):
    """Message class 'AliveTurtlesList'."""
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -3.402823466e+38 or val > 3.402823466e+38) or math.isinf(val) for val in value)), \
                "The 'theta' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
